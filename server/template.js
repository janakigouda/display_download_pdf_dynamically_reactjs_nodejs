                        ...
                        <tbody>
                                 ...
                                 // outer loop
                                    for (let i = 0; i < newData.length; i++) {
                                       // checing the date
                                       // if (newData[i].date == newData[i].date && newData[i].values) {
                                          // console.log(newData[i].date);
                                          a+=`<table style="border:10px solid gainsboro; margin-bottom:50px;">
                                                <tr class="parday" style="margin-top:5px;">
                                                <td>${newData[i].date}</td>`
                                          ...
                                          for (let j = 0; j < newData[i].values.length; j++) {
                                             ...
                                             a+= ` <td>
                                                   <table  style="border-bottom:1px solid gainsboro; margin-top:10px;">
                                                      <tr class="info" >
                                                         <td colspan="2">
                                                            <table>
                                                      ...
                                                      <table style="border-collapse: collapse; border-bottom:1px solid gainsboro; margin-bottom:5px;">
                                                         <tr style="background-color:orange; color:white; padding-bottom:5px;">
                                                            <th> ${mode} </th>
                                                            <th> SNF </th>
                                                            <th> FAT </th>
                                                            <th> QTY </th>
