                     ...
                     <div class="invoice-box">
                        <table>
                           ...
                           <tbody style="width:100%;">`
                                       ...
                                       {
                                          a +=` <tr style="width:100%;"> 
                                                   <td style="width:100%;">
                                                      <table style="border-bottom:1px solid whitesmoke; background-color: orange; color:white; margin-bottom:10px; border-collapse: collapse;">`
                                                         for (let j = 0; j < newData[i].values.length; j++) {
                                                            ...
                                                            a +=` <tr>
                                                                     <td>
                                                                        <tr style="font-weight:bold; font-size:18px; border-bottom:1px solid whitesmoke;">
                                                                           <td style="text-align: center;">${newData[i].values[j].soldTo}</td>
                                                                           <td></td>
                                                                           <td></td>
                                                                           <td></td>
                                                                           <td></td>
                                                                           <td style="text-align: center;">${newData[i].values[j].date}</td>
                                                                        </tr>
                                                                        <tr>
                                                                           <th> ${mode} </th>
                                                                           <th> SNF </th>
                                                                        ...
                                                                        <tr class="total" style="font-weight:bold; border-top:1px solid whitesmoke; border-bottom:1px solid whitesmoke; padding-bottom:5px; margin-bottom:10px;">
                                                                           <td>Total</td>
                                                                           <td></td>
                                                                           <td></td>
