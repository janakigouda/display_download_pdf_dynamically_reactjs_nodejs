                ...
                <html>
                   <head>
                      ...
                      <style type="text/css" media="all">
                         ...
                         .invoice table thead tr td.title img{
                            padding-left:40px;
                         }
                         .invoice table thead tr td.userid{
                            text-align: center;
                            font-size: 17px;
                            font-weight: bold;
                         }
                   ...
                   <body>
                      <div class="invoice">
                         <table>
                            ...
                            <tbody>
                               <tr style='background-color:gray; padding:10px;'> 
                                  <td style=" background-color:blue;  margin-left:20px; margin-right:50px;">
                                     `
                                      // outer loop
                                      for (let i = 0; i < newData.length; i++) {
                                        // checing the date
                                        if (newData[i].date == newData[i].date) {
                                           a+=`<table class="outer-table" style="margin-bottom:2px;">
                                                 <tr class="tabs">
                                                    <td class="tabs1">`
                                                    // inner loop
                                                    ...
                                                    a+=`
                                                       <table class="inner-table">
                                                          <tr class="info-one" >
                                                             <td colspan="2">
                                                                <table class="info-one-table" style="margin-top:5px;">
                                                                   <tr>
                                                                      <td>${newData[i].values[j].soldTo}</td>
                                                                      <td>${newData[i].values[j].date}</td>
                                                                   </tr>
                                                                </table>
                                                             </td> 
                                                          </tr>
                                                          <tr class="info-two">
                                                             <td>
                                                                <table class="info-two-table" style="border-collapse: collapse; width:100%;">
                                                                   <tr>
